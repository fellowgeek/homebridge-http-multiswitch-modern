...
module.exports = (api) => {
  api.registerAccessory('homebridge-http-multiswitch-modern', 'HttpMultiswitchModern', HttpMultiswitch);
};
...
class HttpMultiswitch {
  constructor(log, config, api) {
    ...
    if (this.switchType === 'Switch') {
      ...
      throw new Error(`Unknown homebridge-http-multiswitch-modern switch type: ${this.switchType}`);
    }
  }
